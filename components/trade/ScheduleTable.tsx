              ...
              >
                ...
                <td className="px-1.5 py-2.5 relative align-middle">
                  ...
                  <div className="flex flex-col pl-1">
                    ...
                    <span className="text-[14px] font-black text-slate-800 tabular-nums leading-tight">
                ...
                <td className="px-1.5 py-2.5 align-middle">
                  ...
                  {isBoost && (
                    <div className="text-[9px] text-indigo-500 font-bold mt-0.5">유저 등록</div>
                  )}
                </td>
                ...
                <td className="px-1.5 py-2.5 align-middle">
                  <span
                    className={`inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[10px] font-bold border whitespace-nowrap ${badgeCls}`}
                    title={tooltip}
                  >
                    {isBoost
                      ? <>{event.type || '?'}<span className="opacity-60 text-[9px] ml-0.5">{boostType}</span></>
                      : event.type}
                  </span>
                  {isBoost && (
                    <button
